...
{
    MainNavBarColor = [UIColor colorWithRed:255/255.0 green:255/255.0 blue:255/255.0 alpha:1];
    MainViewColor   = [UIColor colorWithRed:255/255.0 green:255/255.0 blue:255/255.0 alpha:1];
...
- (void)viewWillAppear:(BOOL)animated{
    ...
    if(StatusRect.size.height>20){
        TabbarSafeBottomMargin =34;
    }
    CGRect frame = self.tabBarController.tabBar.frame;frame.origin.y = [UIScreen mainScreen].bounds.size.height - frame.size.height -TabbarSafeBottomMargin;frame.size =CGSizeMake(frame.size.width, frame.size.height+TabbarSafeBottomMargin);
